...
export const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'مناطق التغطية والتوصيل الحالية مخصصة حصرياً لمحافظة بني سويف: (مدينة بني سويف، وبني سويف شرق النيل)، لضمان سرعة الوصول وأعلى درجات الطزاجة والجودة لمناسباتكم.',
    category: 'التوصيل والجودة'
  },
  {
  ...
  },
  {
    ...
    answer: 'لا يمكن إرجاع أو إلغاء الأوردر نهائياً بعد بدء العمل عليه؛ لأن المصنع والمطبخ المركزي يقوم بإنتاج وتجهيز وطهي الوجبات وطباعة الكروت وتخصيص الأشرطة خصيصاً وفورياً لكل عميل بناءً على موعد مناسبته، وبما يتطابق مع معايير السلامة الغذائية.',
  ...
  },
  {
    ...
    answer: 'الشحن والتوصيل غير مشمول في سعر العرض المعلن للباقات بالموقع. والطلبات فقط التي تزيد عن 500 عبوة/طلب هي التي تستحق وتستفيد من الشحن المجاني بالكامل، وذلك حصرياً داخل نطاق محافظتي (بني سويف أو الفيوم).',

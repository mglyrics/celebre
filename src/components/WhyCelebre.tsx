  ...
  const features = [
    {
      ...
      desc: 'نستخدم أجود أنواع اللحوم البلدي والدواجن الطازجة والزبدة الفلاحي الطبيعية والشوكولاتة البلجيكية دون أي إضافات صناعية.',
    },
    {
      icon: Gift,
      title: 'تغليف ملكي فردي يُبهر المعازيم',
      desc: 'صناديق مخملية وأنيقة مع أشرطة ستان وفيونكات يدوية وشوك ومناديل معطرة معقمة تضمن نظافة وسهولة التناول بدون أي فوضى.',
    },
    {
      icon: Clock,
    ...
    {
      icon: Heart,
      title: 'كارت تهنئة مخصص باسم العروسين',
      desc: 'نطبع كروت إهداء أنيقة تحمل أسماء أصحاب المناسبة وتاريخ اليوم لتكون ذكرى جميلة يحتفظ بها ضيوفكم.',
    },
    {
      icon: ShieldCheck,
